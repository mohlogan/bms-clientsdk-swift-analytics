...
public class Feedback {
    ...
    internal static func createZip(instanceName: String) -> Void {
        let zipFilePath = BMSLogger.feedbackDocumentPath+"/../"+instanceName+".zip"
        
        SSZipArchive.createZipFile(atPath: zipFilePath, withContentsOfDirectory: BMSLogger.feedbackDocumentPath+instanceName)
    }
